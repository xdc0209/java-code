...
import org.mozilla.intl.chardet.statistics.Big5Statistics;
import org.mozilla.intl.chardet.statistics.EUCJPStatistics;
import org.mozilla.intl.chardet.statistics.EUCKRStatistics;
import org.mozilla.intl.chardet.statistics.EUCTWStatistics;
import org.mozilla.intl.chardet.statistics.GB2312Statistics;
import org.mozilla.intl.chardet.verifier.nsBIG5Verifier;
import org.mozilla.intl.chardet.verifier.nsCP1252Verifier;
import org.mozilla.intl.chardet.verifier.nsEUCJPVerifier;
import org.mozilla.intl.chardet.verifier.nsEUCKRVerifier;
import org.mozilla.intl.chardet.verifier.nsEUCTWVerifier;
import org.mozilla.intl.chardet.verifier.nsGB18030Verifier;
import org.mozilla.intl.chardet.verifier.nsGB2312Verifier;
import org.mozilla.intl.chardet.verifier.nsHZVerifier;
import org.mozilla.intl.chardet.verifier.nsISO2022CNVerifier;
import org.mozilla.intl.chardet.verifier.nsISO2022JPVerifier;
import org.mozilla.intl.chardet.verifier.nsISO2022KRVerifier;
import org.mozilla.intl.chardet.verifier.nsSJISVerifier;
import org.mozilla.intl.chardet.verifier.nsUCS2BEVerifier;
import org.mozilla.intl.chardet.verifier.nsUCS2LEVerifier;
import org.mozilla.intl.chardet.verifier.nsUTF8Verifier;
    ...
    protected void initVerifiers(int currVerSet)
    {
        ...
        else if (currVerifierSet == nsPSMDetector.ALL)
        {
            ...
            mStatisticsData = new nsEUCStatistics[] { null, null, new EUCJPStatistics(), null, new EUCKRStatistics(),
                    null, new Big5Statistics(), new EUCTWStatistics(), new GB2312Statistics(), null, null, null, null,
                    null, null };
        }
