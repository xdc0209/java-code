...
public class nsEUCSampler
{
    ...
    private int   mFirstByteCnt[]   = new int[94];
    private int   mSecondByteCnt[]  = new int[94];
    private float mFirstByteFreq[]  = new float[94];
    private float mSecondByteFreq[] = new float[94];
