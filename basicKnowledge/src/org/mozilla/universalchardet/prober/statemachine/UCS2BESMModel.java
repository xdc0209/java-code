...
public class UCS2BESMModel extends SMModel
{
    ...
    {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, ucs2beClassTable),
                UCS2BE_CLASS_FACTOR,
    ...
    // constants continued
    ////////////////////////////////////////////////////////////////
    private static int[] ucs2beClassTable   = new int[] { PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),                     // 00 - 07
