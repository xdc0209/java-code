...
public class HZSMModel extends SMModel
{
    ...
    public HZSMModel()
    {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, hzsClassTable),
                HZS_CLASS_FACTOR,
                new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, hzsStateTable),
                hzsCharLenTable, Constants.CHARSET_HZ_GB_2312);
    }

    ////////////////////////////////////////////////////////////////
    // constants continued
    ////////////////////////////////////////////////////////////////
    private static int[] hzsClassTable   = new int[] { PkgInt.pack4bits(1, 0, 0, 0, 0, 0, 0, 0),           // 00 - 07
