...
public class GB18030SMModel extends SMModel
{
    ...
    {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, gb18030ClassTable),
    ...
    // constants continued
    ////////////////////////////////////////////////////////////////
    private static int[] gb18030ClassTable   = new int[] { PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1),           // 00 - 07
