...
public class ISO2022CNSMModel extends SMModel
{
    ...
    {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, iso2022cnClassTable),
    ...
    // constants continued
    ////////////////////////////////////////////////////////////////
    private static int[] iso2022cnClassTable   = new int[] { PkgInt.pack4bits(2, 0, 0, 0, 0, 0, 0, 0),           // 00 - 07
