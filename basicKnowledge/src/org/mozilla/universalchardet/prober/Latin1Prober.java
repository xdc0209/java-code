...
public class Latin1Prober extends CharsetProber
{
    ...
    // constants continued
    ////////////////////////////////////////////////////////////////
    private static final byte[] latin1CharToClass = new byte[] { OTH, OTH, OTH, OTH, OTH, OTH, OTH, OTH,           // 00 - 07
    ...
    private static final byte[] latin1ClassModel  = new byte[] {
            ...
            /* UDF */ 0, 0, 0, 0, 0, 0, 0, 0, /* OTH */ 0, 3, 3, 3, 3, 3, 3, 3, /* ASC */ 0, 3, 3, 3, 3, 3, 3, 3,
            /* ASS */ 0, 3, 3, 3, 1, 1, 3, 3, /* ACV */ 0, 3, 3, 3, 1, 2, 1, 2, /* ACO */ 0, 3, 3, 3, 3, 3, 3, 3,
            /* ASV */ 0, 3, 1, 3, 1, 1, 1, 3, /* ASO */ 0, 3, 1, 3, 1, 1, 3, 3, };
}
