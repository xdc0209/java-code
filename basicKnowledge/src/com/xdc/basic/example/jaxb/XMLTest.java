...
{
	private String	users	= "<users>	<user>	    <name>小李</name>		<sex>男</sex>		<age>24</age></user><user>		<name>小丽</name><sex>女</sex><age>18</age>	</user><user><name>小王</name><sex>男</sex><age>22</age></user></users> ";
	...
	public static void main(String[] args)
	{
		...
		try
		{
			Users users = (Users) xmlConvertor.xml2java(users);
