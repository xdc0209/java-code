package com.xdc.basic.api.args.args4j.randombasedonargs4j2029.subcommand.sqlcommand;
...
import com.xdc.basic.api.args.args4j.randombasedonargs4j2029.subcommand.AbstractCommand;
...
public class OracleCommand extends AbstractCommand
{
    ...
    @Override
    protected void excute(CmdLineParser parser)
    {
        // 不实现具体逻辑，仅用来展示子命令解析
