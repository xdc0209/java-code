...
public class EveryMonth implements Repeat
{
    /**
     * 每月的哪几天应该响铃，合法值为：[1-31]
     */
    private Set<Integer> days = new HashSet<Integer>(31);
    ...
    {
        return days.contains(now.get(Calendar.DAY_OF_MONTH));
    }
