 ...
 * holder.
 */
package com.xdc.basic.tools.restserver.jersey.application.resource.asyncdemo;
...
public class LongRunningAsyncOperationResource
{
    private static final ExecutorService TASK_EXECUTOR         = Executors
            .newCachedThreadPool(new ThreadFactoryBuilder().setNameFormat("long-running-resource-executor-%d").build());
