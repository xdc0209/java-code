...
public class AdjacencyListGraph<T> extends AbstractGraph<T>
{
    ...
    public AdjacencyListGraph(int maxVertexNum, boolean directed)
    {
    ...
    public int addVertex(T data)
    {
        ...
        Edge head = new Edge(-1, Integer.MAX_VALUE);
    ...
    public int getEdge(int v1, int v2)
    {
        ...
        Edge edge = ((Vertex) vertexes[v1]).head.next;
        while (edge != null)
        {
            if (edge.adjvex == v2)
            {
