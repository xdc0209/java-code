...
{
    // 表中对应00-ff所有的CRC结果。查表法实现crc16算法，不用每次都计算效率更高。摘自：http://wdhdmx.iteye.com/blog/1464269
    private static int[] crc16_table = { 0x0000, 0x1021, 0x2042, 0x3063, 0x4084, 0x50a5, 0x60c6, 0x70e7, 0x8108, 0x9129,
    ...
    {
        String crc = CRC16Util.crc(bytes);
    ...
    // System.out.println(CRC16Util.crc(s.getBytes()));
    // }
}
