...
public class JdbcRantDaoWithSqlObjects extends JdbcDaoSupport implements RantDao
{
    ...
    private static final String  VEHICLE_SELECT           = "select id, plateNumber, state, motorist_id from vehicle";
    ...
    private static final String  VEHICLE_BY_PLATE_SELECT  = VEHICLE_SELECT
            + " where state=:state and plateNumber=:plateNumber";
    ...
    public Vehicle findVehicleByPlate(String state, String plateNumber)
    {
        ...
        JdbcVehicle vehicle = (JdbcVehicle) vehicleByPlateQuery.findObjectByNamedParam(parameters);
    ...
    protected class VehicleInsert extends SqlUpdate
    {
        ...
        {
            update(new Object[] { vehicle.getPlateNumber(), vehicle.getState(), vehicle.getMotorist().getId() });
        }
    }
