...
public class PokerHandEvaluatorImpl implements PokerHandEvaluator
{
    ...
    private boolean isFullHouse(Card[] cards)
    {
        ...
        return pattern.equals(FULL_HOUSE_PATTERN_1) || pattern.equals(FULL_HOUSE_PATTERN_2);
    }

    private boolean isFourOfAKind(Card[] cards)
    {
        String pattern = getFacePattern(cards);
        return pattern.equals(FOUR_OF_A_KIND_PATTERN_1) || pattern.equals(FOUR_OF_A_KIND_PATTERN_2);
    }

    private boolean isThreeOfAKind(Card[] cards)
    {
        String pattern = getFacePattern(cards);
        return pattern.equals(THREE_OF_A_KIND_PATTERN_1) || pattern.equals(THREE_OF_A_KIND_PATTERN_2)
    ...
    {
        String pattern = getFacePattern(cards);
        return pattern.equals(TWO_PAIR_PATTERN_1) || pattern.equals(TWO_PAIR_PATTERN_2)
    ...
    private boolean isPair(Card[] cards)
    {
        ...
        return (pattern.indexOf("AA") >= 0 || pattern.indexOf("BB") > 0 || pattern.indexOf("CC") > 0
